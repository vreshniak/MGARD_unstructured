...
int main(int argc, char *argv[])
{
	...
	// read config file
	if (argc<4){
		std::cerr << "Usage: add_ordering config.json input.bp output.bp, `add_ordering` got " << argc-1 << " parameters" << std::endl;
		return -1;
	}
	...
	adios2::Engine bpWriter = writer_io.Open(output_file_name, adios2::Mode::Append);


	///////////////////////////////////////////////////////////////////////////
	// define output ADIOS variables
	adios2::Variable<int64_t> out_adios_order = writer_io.DefineVariable<int64_t>(config["node_order"], {}, {}, {adios2::UnknownDim});
