...
int main(int argc, char *argv[])
{
	...
	// read config file
	if (argc<3){
		std::cerr << "Usage: add_ordering config.json filename" << std::endl;
		return -1;
	}
	...
	adios2::Variable<int64_t> out_adios_order = writer_io.DefineVariable<int64_t>("node_order", {}, {}, {adios2::UnknownDim});
